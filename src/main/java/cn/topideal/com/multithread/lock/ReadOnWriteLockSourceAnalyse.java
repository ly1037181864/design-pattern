 ...
 * 读写锁的源码分析
 */
public class ReadOnWriteLockSourceAnalyse implements ReadWriteLock, java.io.Serializable {

    private static final long serialVersionUID = -6992448646407690164L;
    /**
     * Inner class providing readlock
     */
    private final ReadOnWriteLockSourceAnalyse.ReadLock readerLock;
    /**
     * Inner class providing writelock
     */
    private final ReadOnWriteLockSourceAnalyse.WriteLock writerLock;
    /**
     * Performs all synchronization mechanics
     */
    final ReadOnWriteLockSourceAnalyse.Sync sync;

    /**
     * Creates a new {@code ReentrantReadWriteLock} with
     * default (nonfair) ordering properties.
     */
    public ReadOnWriteLockSourceAnalyse() {
        this(false);
    }
     ...
     */
    public ReadOnWriteLockSourceAnalyse(boolean fair) {
    ...
    @Override
    public ReadOnWriteLockSourceAnalyse.WriteLock writeLock() {
        return writerLock;
    }

    @Override
    public ReadOnWriteLockSourceAnalyse.ReadLock readLock() {
        return readerLock;
    }
    ...
    public static class ReadLock implements Lock, java.io.Serializable {
         ...
         */
        protected ReadLock(ReadOnWriteLockSourceAnalyse lock) {
            sync = lock.sync;
        }
    ...
    public static class WriteLock implements Lock, java.io.Serializable {
         ...
         * @throws NullPointerException if the lock is null
         */
        protected WriteLock(ReadOnWriteLockSourceAnalyse lock) {
            sync = lock.sync;
        }
    ...
    public boolean hasWaiters(Condition condition) {
        ...
        if (!(condition instanceof AQSSourceAnalyse.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.hasWaiters((AQSSourceAnalyse.ConditionObject) condition);
    }
    ...
    public int getWaitQueueLength(Condition condition) {
        ...
        if (!(condition instanceof AbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitQueueLength((AQSSourceAnalyse.ConditionObject) condition);
    }
    ...
    protected Collection<Thread> getWaitingThreads(Condition condition) {
        ...
        if (!(condition instanceof AbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitingThreads((AQSSourceAnalyse.ConditionObject) condition);
    }
